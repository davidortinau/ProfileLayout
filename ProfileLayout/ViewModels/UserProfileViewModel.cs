...
using ProfileLayout.Models;
using ProfileLayout.Utils;

namespace ProfileLayout.ViewModels
{
	public class UserProfileViewModel : INotifyPropertyChanged
	{
		...
		//public async Task OnSelectPhoto()
		//{
		//	if (!CanSave)
		//	{
		//		return;
		...
		//			var filePath = await dependencyService.Get<IPhotoService>().StorePhoto(mediaFile, "profilePhoto", dependencyService.Get<IWhatPathService>().PersonalPath);
		//			Settings.ProfilePhoto = filePath;
